...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.softness_slider.sliderMoved.connect(self.softness_spinBox.setValue)
        self.softness_spinBox.valueChanged.connect(self.softness_slider.setValue)
        ...
        self.lockOri_spinBox.valueChanged.connect(self.lockOri_slider.setValue)
        self.lockOri_slider.valueChanged.connect(self.lockOri_spinBox.setValue)
        self.softness_slider.valueChanged.connect(self.softness_spinBox.setValue)
