"""Guide leg_3jnt_01_autoscapula module"""
...
# guide info
AUTHOR = "Miquel Campos, custom mod"
URL = "www.mcsgear.com"
EMAIL = ""
VERSION = [1, 0, 0]
TYPE = "leg_3jnt_01_autoscapula"
NAME = "leg"
DESCRIPTION = (
    "3 bones leg for quadrupeds with auto-scapula. "
    "The scapula joint automatically orients toward the foot IK target, "
    "simulating how a horse front leg shoulder blade rotates as the leg extends. "
    "Use the autoScapula attribute (0-1) to blend between manual and driven."
)
...
class Guide(guide.ComponentGuide):
    ...
    def addParameters(self):
        ...
        # Auto-scapula intensity (default 0.5 — half driven)
        self.pAutoScapula = self.addParam("autoScapula", "double", 0.5, 0, 1)

        # Default Values (same as leg_3jnt_01)
...
class componentSettings(MayaQWidgetDockableMixin, guide.componentMainSettings):
    ...
    def populate_componentControls(self):
        ...
        # Auto-scapula
        self.settingsTab.autoScapula_slider.setValue(
            int(self.root.attr("autoScapula").get() * 100)
        )
        self.settingsTab.autoScapula_spinBox.setValue(
            int(self.root.attr("autoScapula").get() * 100)
        )
    ...
    def create_componentConnections(self):
        ...
        self.settingsTab.autoScapula_slider.valueChanged.connect(
            partial(self.updateSlider, self.settingsTab.autoScapula_slider, "autoScapula")
        )
        self.settingsTab.autoScapula_spinBox.valueChanged.connect(
            partial(self.updateSlider, self.settingsTab.autoScapula_spinBox, "autoScapula")
        )
